...
public class AdminCommentDeleteByAdmin extends BaseController{
	private static final long serialVersionUID = -1837009293676229703L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return "comment/comment_deleteByAdmin";
	}
