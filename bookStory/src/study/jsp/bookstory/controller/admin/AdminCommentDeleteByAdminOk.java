...
@WebServlet("/admin/commentDeleteByAdminOk.do")
public class AdminCommentDeleteByAdminOk extends BaseController{
	private static final long serialVersionUID = -6604762824868462198L;
