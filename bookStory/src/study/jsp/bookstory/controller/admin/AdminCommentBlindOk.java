...
@WebServlet("/admin/commentBlindOk.do")
public class AdminCommentBlindOk extends BaseController{
	private static final long serialVersionUID = 8561703090477683601L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			reportService.updateReportedCommentBlind(report);
		}catch (Exception e) {
