...
/**
 * Servlet implementation class EpisodeCommentInsert
 */
@WebServlet("/episodecomment/episode_comment_insert.do")
public class EpisodeCommentInsert extends BaseController {

	private static final long serialVersionUID = 6244316340510258404L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Comment item = null;
		try{
			commentService.insertEpisodeComment(comment);
			item = commentService.selectEpisodeComment(comment);
		}catch(Exception e){
