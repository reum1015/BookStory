...
/**
 * Servlet implementation class EpisodeCommentDelete
 */
@WebServlet("/episodecomment/episode_comment_delete.do")
public class EpisodeCommentDelete extends BaseController {

	private static final long serialVersionUID = -1474656849190069917L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginInfo!=null){
			...
			web.redirect(web.getRootPath() + "/novelview/view_page.do", "로그인 후에 이용 가능합니다.");
			return null;
		}
		...
		return "episodecomment/episode_comment_delete";
	}
