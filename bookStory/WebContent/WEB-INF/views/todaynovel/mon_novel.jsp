  ...
  -->
			...
			<nav class="navbar navbar-default main_navi main_navi_sub">
  					<div class="container main_navi_sub_list">
    					<div class="" id="myNavbar_sub">
      						<ul class="nav navbar-nav">
						        <li class="day_active"><a href="./todayNovel.jsp">월요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/tue_novel.jsp">화요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/wen_novel.jsp">수요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/thu_novel.jsp">목요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/fri_novel.jsp">금요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/sat_novel.jsp">토요일</a></li>
						        <li><a href="${pageContext.request.contextPath}/todaynovel/sun_novel.jsp">일요일</a></li>
