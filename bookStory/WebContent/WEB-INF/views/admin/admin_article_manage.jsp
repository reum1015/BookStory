  							...
  							<div class="container main_navi_sub_list">
    							<div class="" id="myNavbar_sub">
		      						<ul class="nav navbar-nav">
								        ...
								        <li><a href="${pageContext.request.contextPath}/admin/articlemanage.jsp">게시판 관리</a></li>
								        <li><a href="${pageContext.request.contextPath}/admin/replyManage.jsp">댓글 관리</a></li>
