...
<body>
	...
	<div class="container main_container">
		<div class="Article_size">
			...
			<div class="alert alert-info">
				<h3 style="margin: 0">
					${readArticle.subject}<br /> <small> 작성자 :
						${readArticle.user_nickname} / 조회수 : ${readArticle.hit} / 작성일시 :
			...
			<!--덧글 신고 모달 -->
			<div class="modal fade" id="reply_toadmin" tabindex="-1"
				role="dialog" aria-labelledby="edit" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
			...
			<form id="comment_form" method="post"
				action="${pageContext.request.contextPath}/comment/comment_insert.do">
				<!-- 글 번호 상태 유지 -->
			...
			$.get("${pageContext.request.contextPath}/comment/comment_list.do",
					{
						...
						for (var i = 0; i < json.item.length; i++) {
							json.item[i].content = json.item[i].content
									.replace(/&lt;br\/&gt;/g, "<br/>");
