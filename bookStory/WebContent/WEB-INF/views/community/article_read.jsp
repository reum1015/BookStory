...
<body>
	...
	<div class="container main_container">
		<div class="Article_size">
			...
			<section>
				...
				<div class="alert alert-info">
					<h3 style="margin: 0">
						${readArticle.subject}<br /> <small> 작성자 :
							${readArticle.member_id} / 조회수 : ${readArticle.hit} / 작성일시 :
							${readArticle.reg_date} </small>
					</h3>
				</div>
				<!-- 내용 -->
				<section style="padding: 0 10px 20px 10px">
					${readArticle.content}</section>
				<!-- 다음글/이전글 -->
				...
				<div class="clearfix">
					<div class="pull-left">
						<button type="submit" class="btn btn-danger btn-sm"
							data-toggle="modal" data-target="#Article_Report">신고</button>
					</div>
					<div class="pull-right">
						<a
							href="${pageContext.request.contextPath}/community/article_list.do?category=${category}"
						...
						<a
							href="${pageContext.request.contextPath}/community/article_edit.do?category=${category}&article_id=${readArticle.id}"
							class="btn btn-warning">수정하기</a> <a
							href="${pageContext.request.contextPath}/community/article_delete.do?category=${category}&article_id=${readArticle.id}"
		...
		<!-- 게시글 신고 모달 -->
		<div class="modal fade" id="Article_Report" tabindex="-1"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="col">
							...
							<input name="radioGroup" id="radio1" value="report1" checked="checked" type="radio">
							음란성 또는 청소년에게 부적합한 내용
							</label> <label class="radio-inline">
							<input name="radioGroup" id="radio2" value="report2" type="radio">
							폭언 또는 욕설 내용
							</label><label class="radio-inline">
							<input name="radioGroup" id="radio3" value="report3" type="radio">
							게시물 광고 내용
							</label>
						</div>
					...
					<div class="modal-footer ">
						<button type="button" class="btn btn-success">
							<span class="glyphicon glyphicon-ok-sign"></span> 예
						</button>
