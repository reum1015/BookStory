...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/article/articleWrite.css" />
...
<body>
	...
	<div class="container main_container">
		...
		<div class="left-block">
	    	<img src="${pageContext.request.contextPath}/assets/imgs/article/FreeArticle1.png" alt="자유게시판" class="img-rounded left-block">
		</div>
		<section>
			<form role="form">
				<div class="form-group Article1">
					<label for="ArticleName" class="col-xs-2 col-sm-2 control-label text-center">제목</label>
				...
				<div class="col-xs-2 col-sm-2 Article1">
					<a href="./article_list.jsp"><button type="button" class="btn btn-default btn-sm pull-right">목록</button></a>
				</div>
