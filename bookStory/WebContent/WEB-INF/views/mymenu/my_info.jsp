			...
			<form class="form-horizontal" role="form">
				<fieldset>
					...
					<div class="container cc">
						<a class="btn btn-warning" href="${pageContext.request.contextPath}/mymenu/info_change.jsp">정보수정</a>
						<a class="btn btn-danger" href="${pageContext.request.contextPath}/mymenu/out.jsp">회원탈퇴</a>
