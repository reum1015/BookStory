...
<link rel="stylesheet" type="text/css" href="../assets/css/mymenu/InfoChange.css" />
<link rel="stylesheet" href="../assets/js/plugins/pickadate/themes/default.css" />
<link rel="stylesheet" href="../assets/js/plugins/pickadate/themes/default.date.css" />
			...
			<fieldset>
				...
				<form id="join_form" method="post">
					...
					<div class="form-group">
	                 ...
	                 <div class="form-group">
					<a class="btn btn-block btn-warning" href="${pageContext.request.contextPath}/mymenu/info_change_success.jsp">확인</a>
					</div>
