	...
	<div id="container main_container">
		<div class="container bb">
           ...
           <div class="form-group">
             <a href="${pageContext.request.contextPath}/index.jsp" class="btn btn-warning col-md-6">취소</a>
             <a href="${pageContext.request.contextPath}/mymenu/out_success.jsp" class="btn btn-warning col-md-6">확인</a>
			</div>
<br> <br>
