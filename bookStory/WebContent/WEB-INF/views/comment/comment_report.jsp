...
<form id="episode_comment_report_form" method="post" 
	...
	<div class="modal-footer">
		...
		<c:when test="${reportCount > 0 && readComment.member_id != loginInfo.id}">
			<div class="modal-body">
		...
		<c:when test="${readComment.member_id != loginInfo.id && reportCount <= 0}">
		<div class="modal-body">
	<p>이게시물을 신고 하시겠습니까?</p>
	...
	<div class="modal-footer">
		...
		<c:when test="${readComment.member_id == loginInfo.id}">
				<div class="modal-body">
