			...
			<div class="col-xs-12 col-sm-4 text-center section_area list_rank box">
  						...
  						<div class="">
  							<div>
	  							...
	  							<div class="btn-group btn-group-justified totla_rank_gender">
								  <a href="#" class="btn btn-primary">10대</a>
								  <a href="#" class="btn btn-primary">20대</a>
								  <a href="#" class="btn btn-primary">30대</a>
								  <a href="#" class="btn btn-primary">40대</a>

							</div>		  
								</div>
  							<div class="list-group total_rank">
