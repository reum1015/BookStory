			...
			<div class="container clearfix main_header_wrapperdiv">
				...
				<!-- 메인 헤더 로그인 회원가입 화면-->
				     <ul class="nav navbar-nav navbar-right hidden-xs">
				        <li><a href="/bookStory/Login/SignUpAgree.jsp"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
				        <li><a href="/bookStory/Login/Login.jsp"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
   					</ul>
				
				<!-- 메인 헤더 이미지 -->
				<div class="container main_header_image">
					<h1 class="main_h1">
						<a href="/bookStory/index.jsp" id="main_image_link"></a>
					</h1>
			...
			<nav class="navbar navbar-default main_navi">
  				<div class="container">
    				<div class="navbar-header clearfix">   
     				...
     				<a href="/bookStory/index.jsp" class="navbar-brand bookstoryhome">BookStory</a>
    			</div>
    				<div class="container">
    					<div class="collapse navbar-collapse" id="myNavbar">
      						<ul class="nav navbar-nav">
						        <li class="todayNovel"><a href="/bookStory/todayNovel/todayNovel.jsp">TodayNovel</a></li>
						        <li class="novelList"><a href="/bookStory/novelList/novelList.jsp">NoveList</a></li>
						        <li class="community"><a href="/bookStory/community/articleList.jsp">Community</a></li>
						        <li class="mymenu"><a href="/bookStory/myMenu/recentNovelList.jsp">MyMenu</a></li>
       							<li class="main_admin"><a href="/bookStory/admin/adminUserInfo.jsp" class="main_navi_admin active">administrator</a></li>
